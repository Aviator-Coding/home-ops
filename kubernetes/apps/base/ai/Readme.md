...
| LLM governance (in-cluster only) | `litellm/` | Virtual keys/budgets, no gateway wiring, fronts nothing. Delivered by `litellm.home-operations.com/v1alpha1` CRs. See `litellm/README.md` and `docs/ai-system/litellm/README.md`. |
