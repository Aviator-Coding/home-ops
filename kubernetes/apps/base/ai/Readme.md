...
| LLM governance (internal only) | `litellm/` | Virtual keys/budgets/fallback chains. Internal route only (`litellm.${SECRET_DOMAIN}` on `envoy-internal`, captain-approved 2026-08-26); never the public listener. Delivered by `litellm.home-operations.com/v1alpha1` CRs. See `litellm/README.md`, `docs/ai-system/litellm/README.md` and `docs/ai-system/litellm/fallbacks.md`. |
