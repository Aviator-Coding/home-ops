...
| [`kubernetes/components/kopiur/Readme.md`](../kubernetes/components/kopiur/Readme.md) | kopiur backup component (authoritative migration status: 29 of 29 onboarded, zero deferred, VolSync RETIRED from 7 of them across two 2026-09 waves, and `downloads/autobrr` removed with its app on 2026-09-02; retirement procedure and the pvc Component, schedules, wait:true split, per-namespace r2 hours, credential projection, mover-identity, privileged-mover root gate, SecurityContextCompatible semantics, rollback). |
...
Fleet PVC backup is kopiur on **29** protected claims, with VolSync alongside it on **22** of them and **retired** from the other 7 across two Stage 5 waves (the fleet was 30 until `downloads/autobrr` was removed with its app on 2026-09-02 - captain decision, unused; its kopia snapshots were deliberately kept - `backups/autobrr-removal-2026-09-02.md`) (live claim list and `ReplicationSource` count: [`kubernetes/components/volsync/Readme.md`](../kubernetes/components/volsync/Readme.md)). **All 30 claims are restore-proven on BOTH ceph and r2** as of 2026-09-01 - authority [`backups/kopiur-restore-proof-2026-09-01.md`](backups/kopiur-restore-proof-2026-09-01.md). That fleet proof is the Stage 5 **prerequisite**. Wave one (2026-09-01) retired VolSync from `ai/repo-wiki`, `downloads/recyclarr-config`, `downloads/sabnzbd-config` and `media/seerr` ([`backups/kopiur-stage5-pilot-retirement-2026-09-01.md`](backups/kopiur-stage5-pilot-retirement-2026-09-01.md)); wave two (2026-09-02) retired `downloads/prowlarr-config`, `selfhosted/ntfy`, `downloads/autobrr` (app since removed) and `selfhosted/obsidian-livesync` ([`backups/kopiur-wave-two-retirement-2026-09-02.md`](backups/kopiur-wave-two-retirement-2026-09-02.md), authorised by [`backups/kopiur-wave-two-reproof-2026-09-02.md`](backups/kopiur-wave-two-reproof-2026-09-02.md) part 4). Seven of those eight are now kopiur-only and still in the fleet (autobrr left with its app); the remaining 22 stay dual-engine (`selfhosted/paperless-ngx` permanently). Finding 2 of the fleet proof (r2 needs more kopia cache than ceph) is **closed for `ai/hermes`** - 16Gi and r2-proven end-to-end ([`backups/kopiur-r2-restore-cache-gate-2026-09-02.md`](backups/kopiur-r2-restore-cache-gate-2026-09-02.md), authority on cache sizing); `media/tdarr` is also r2-proven at 10Gi and the standing-populator drift class is closed against `main` ([`backups/kopiur-populator-drift-2026-09-02.md`](backups/kopiur-populator-drift-2026-09-02.md)); `media/plex` 10Gi is predicted safe but not itself r2-exercised. Earlier spot checks remain accurate and are still the procedural precedent - Stage 2 `sabnzbd-config` (ceph + r2, byte-identical; gate **passed** 2026-08-30), Stage 4 `changedetection-config`, and Stage 4 `matter-server` (ceph only) - owner [`components/kopiur/Readme.md`](../kubernetes/components/kopiur/Readme.md). Operator/repos: [`kopiur/README.md`](../kubernetes/apps/base/system/kopiur/README.md).
...
| [`backups/kopiur-wave-two-retirement-2026-09-02.md`](backups/kopiur-wave-two-retirement-2026-09-02.md) | Stage 5 wave two: VolSync retired from 4 more volumes (2026-09-02; 8 kopiur-only total). Pure GitOps ship with live verification deferred post-merge (78→66 `ReplicationSource`s). |
