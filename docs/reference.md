...
| [`backups/kopiur-restore-proof-2026-09-01.md`](backups/kopiur-restore-proof-2026-09-01.md) | Fleet restore-proof evidence table for all 30 kopiur claims on both ceph and r2 (2026-09-01). Authority on restore coverage and the Stage 5 prerequisite (retirement still not done); includes CACHEDIR.TAG adjudication and the open r2-vs-ceph cache-capacity blocker. |
