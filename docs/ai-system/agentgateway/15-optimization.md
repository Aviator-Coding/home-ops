...
Ollama hostnames, GPT-3.5-turbo as the default test model, and "LiteLLM as the recommended `/v1` proxy" do not apply (LiteLLM is a separate governance path, not this gateway's `/v1` - `../litellm/README.md`).
