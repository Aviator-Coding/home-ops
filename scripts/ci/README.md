...
| `kopiur-restore-cache-sizing-test.py` | kopiur r2 restore cache gate (2026-09-02, plex closure 2026-09-12): parsed Flux `postBuild.substitute` pins `ai/hermes` 16Gi and `media/plex` 10Gi, self-checks pins clear the measured ~6.2 GiB plateau, fleet-wide Gi/Mi parse guard, both proof docs present |
